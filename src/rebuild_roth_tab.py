...
def main():
    ...
    data_cell(ws, row, 3, 'From sold positions section', font=NOTE_FONT)
    row += 1
    ...
    # Data loaded from data/fidelity_roth_ira.json
    holdings = [
        ('VOO', 20, 520.00, 10400.00, 9000.00),
        ('SCHD', 40, 80.00, 3200.00, 2800.00),
        ('Cash', None, None, 50.00, None),
    ]
    ...
    monthly_data = {
        'Jan': {'begin': 15000.00, 'add': 500.00, 'sub': 0, 'div': 30.00,
                'change': 200.00, 'end': 15730.00},
    }
    ...
    sold_2026 = [
        ('SPY', 'Jan 2026', 10, 4800.00, 5200.00, 'Rebalance'),
    ]
