...
def main():
    ...
    data_cell(ws, row, 2, 50.00, fmt=DOLLAR)  # Data loaded from data/fidelity_hsa.json
    data_cell(ws, row, 3, 'Example sold position (placeholder)', font=NOTE_FONT)
    row += 1
    ...
    # Data loaded from data/fidelity_hsa.json
    holdings = [
        ('FXAIX', 30, 210.00, 6300.00, 5500.00),
        ('Cash', None, None, 200.00, None),
    ]
    ...
    # Data loaded from data/fidelity_hsa.json
    monthly_data = {
        'Jan': {'begin': 8000.00, 'add': 300.00, 'sub': 0, 'div': 10.00,
                'change': 100.00, 'end': 8410.00},
    }
    ...
    # Data loaded from data/fidelity_hsa.json
    sold_2026 = [
        ('FXAIX', 'Jan 2026', 5.0, 900.00, 950.00, 'Rebalance'),
    ]
