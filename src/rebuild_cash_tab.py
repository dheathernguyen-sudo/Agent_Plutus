...
def main():
    ...
    # Account labels — loaded from data/cash.json if available, otherwise empty
    try:
        from pathlib import Path as _P
        _cash_cfg = _P(__file__).parent.parent / "data" / "cash.json"
        acct_labels = json.loads(_cash_cfg.read_text()) if _cash_cfg.exists() else {}
    except Exception:
        acct_labels = {}
