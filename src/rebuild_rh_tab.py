...
def main():
    ...
    data_cell(ws, row, 3, 'Sold positions (proceeds - cost basis)', font=NOTE_FONT)
    row += 1
    ...
    holdings = [
        ('NVDA', 10, 130.00, 1300.00, 100.00, 1000.00),
        ('TSLA', 5, 250.00, 1250.00, 200.00, 1000.00),
        ('AAPL', 8, 175.00, 1400.00, 150.00, 1200.00),
    ]
    ...
    data_cell(ws, row, 4, -1000.00, fmt=DOLLAR)
    margin_debt_row = row
    row += 1
    ...
    data_cell(ws, row, 2, 1500.00, fmt=DOLLAR)
    row += 1

    data_cell(ws, row, 1, 'Ending Margin Debt')
    data_cell(ws, row, 2, 1000.00, fmt=DOLLAR)
    row += 1
    ...
    sold_2026 = [
        ('XYZ', 'Feb 2026', 10, 1500.00, 1800.00, 'Full exit'),
        ('ABC', 'Mar 2026', 5, 1000.00, 950.00, 'Full exit'),
    ]
    ...
    sold_2025 = [
        ('DEF', 'Jan 2025', 5, None, 500.00, 'Full exit'),
        ('GHI', 'Jan 2025', 10, None, 1200.00, 'Full exit'),
        ('JKL', 'Mar 2025', 2, 300.00, 350.00, 'Trim'),
    ]
