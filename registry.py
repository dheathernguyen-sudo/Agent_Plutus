...
REGISTRY = {
    ...
    "Robinhood": {
        ...
        "total_ytd":          ("B", 17, "Total YTD"),
        "holdings_total":     ("D", 29, "TOTAL"),
        "monthly_jan":        ("B", 33, "Jan"),
        "monthly_dec":        ("B", 44, "Dec"),
        "monthly_totals":     ("B", 46, "Totals"),
        "sold_2026_total":    ("F", 53, "2026 TOTAL"),
    },
    ...
    "Cash": {
        "total_cash":         ("C",  9, "TOTAL EXTERNAL CASH"),
    },
    ...
    "Dashboard": {
        ...
        "hsa":                ("A", 24, "HSA"),
        "roth_ira":           ("A", 25, "Roth IRA"),
        "robinhood":          ("A", 26, "Robinhood"),
        "liquid":             ("B", 27, "LIQUID SUBTOTAL"),
        "cash":               ("A", 29, "EXTERNAL CASH"),
        "angel":              ("A", 31, "Angel Investments"),
        "k401":               ("A", 32, "401(k)"),
